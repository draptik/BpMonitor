...
code/
├── BpMonitor.slnx
├── BpMonitor.Core              # Domain models (BloodPressureReading + FamilyMember), interfaces, PasswordHashing, business logic; owns the Strings/Language string table (see ADR 0008)
